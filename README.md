...
The database is seeded with 80+ properties across 38 cities (Kyiv, Lviv, Berlin, Kyoto, Lisbon and more), 40+ hosts, ~200 bookings in every status, and hand-written reviews with category ratings. Only the demo user above is public; seeded host/admin accounts use private passwords.
